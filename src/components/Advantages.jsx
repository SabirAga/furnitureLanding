export const Advantages = () => {
    return (
        <>
            <div className="grid grid-cols-2 px-4 justify-items-center items-center md:flex  md:justify-center lg:items-center font-questrial h-fit md:h-[420px]  ">
                <div className="font-questrial font-bold text-4xl mr-[81px]">
                    <h2>Why</h2>
                    <h2>Choosing Us</h2>
                </div>
                <ul className="grid md:grid-cols-2  md:gap-x-10 lg:flex gap-x-[41px]" >
                    <li className="w-[284px]">
